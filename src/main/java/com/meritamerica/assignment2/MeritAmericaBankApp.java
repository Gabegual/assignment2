...
public class MeritAmericaBankApp {
	public static void main(String[] args) {
		...
		AccountHolder ah1 = new AccountHolder("Gabe", "Francisco", "Gual", "420-40-8008");
		...
		AccountHolder ah2 = new AccountHolder("Kiwi", "Fran", "gual", "420-19-4566");
		...
		AccountHolder ah3 = new AccountHolder("Karen", "jes", "Marq", "123-46-1997");
